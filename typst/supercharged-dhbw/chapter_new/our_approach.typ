...
All curretnt opensource approcahes relie soley on the direct inferencing without any Chain of though or intermediate reasoning steps. tjhe ARCitect, as well as Ice Cuber had no measures in place, that actually tried extract the reasoning part and logical thinking requried to solve an arc task. Yet, as we can clearly see on the benchmark pubkishged by ARC that reasoning model like openais o1 or o3 score higher out of the box than non reasoning models.
