export N_GPUS=2
export BASE_MODEL=./checkpoints/TinyZero/arc_agi_two-qwen2.5-7B_easy_boost/actor/global_step_20
export DATA_DIR=./data/arc_agi_two
export ROLLOUT_TP_SIZE=1
export EXPERIMENT_NAME=arc_agi_two-qwen2.5-7B_easy_boost_content
